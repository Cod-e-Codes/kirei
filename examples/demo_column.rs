...
use kirei::gui::widgets::{Align, Button, Column, Label, Panel, ScrollView};
use std::sync::Arc;
use winit::{
...
impl State {
    async fn new(window: Arc<Window>) -> Self {
        ...
        // Create UI showcasing different Column layouts
        let content = Column::new()
            .push(Label::new("Column Layout Demos").with_color([0.2, 0.6, 1.0, 1.0]))
            .push(Label::new(
                "Notice how align_items affects horizontal alignment",
            ))
            .push(Label::new(""))
            // Column with Align::Start (default - items stay narrow on left)
            .push(
                Label::new("Column with Align::Start (items stay narrow):")
            ...
            .push(Panel::new(
                Column::new()
                    ...
                    .push(Button::new("This is a very long button text"))
                    .align_items(Align::Start),
            ))
            .push(Label::new(""))
            // Column with Align::Center
            .push(Label::new("Column with Align::Center:").with_color([0.8, 0.8, 0.8, 1.0]))
            .push(Panel::new(
                Column::new()
                    .push(Button::new("Short"))
                    .push(Button::new("Medium Button"))
            ...
            .push(Label::new(""))
            // Column with Align::End
            .push(Label::new("Column with Align::End:").with_color([0.8, 0.8, 0.8, 1.0]))
            .push(Panel::new(
                Column::new()
                    .push(Button::new("Short"))
                    .push(Button::new("Medium Button"))
            ...
            .push(Label::new(""))
            // Note about stretching
            .push(
                Label::new("Note: Currently Align only supports Start, Center, and End")
                    .with_color([0.8, 0.8, 0.8, 1.0]),
            )
            .push(
                Label::new("For full-width buttons, you'll need to implement Align::Stretch")
...
impl ApplicationHandler for App {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        if self.state.is_none() {
            let window_attributes = Window::default_attributes().with_title("Column Layout Demos");
